...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`w-[240px] -left-[240px] sm:w-[280px] sm:-left-[280px] peer-focus:left-0 ease-out delay-150 duration-300 shadow-2xl sm:shadow-none h-screen fixed sm:sticky top-0 z-50 sm:z-0 bg-white px-4 mr-0.5`}>
